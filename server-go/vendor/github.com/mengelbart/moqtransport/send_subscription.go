...
type sendSubscription struct {
	...
	firstObjectSent bool
}

func newSendSubscription(conn Connection, subscribeID, trackAlias uint64, namespace, trackname string, filterType wire.FilterType) *sendSubscription {
